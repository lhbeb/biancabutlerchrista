export const metadata = {
    title: "Terms of Service - Bianca Butler Christa",
                    ...
                    <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl p-8 sm:p-12">
                        <div className="prose prose-lg max-w-none">
                            <p className="text-xl text-gray-700 mb-8">
                                Welcome to Bianca Butler Christa. By engaging our web design services, you agree to be bound by these Terms of Service.
                            </p>

                            <h2 className="text-3xl font-bold mt-12 mb-6">1. Services</h2>
                            <p className="text-gray-700 mb-6">
                                Bianca Butler Christa provides professional web design and development services. The specific services, deliverables, timeline, and pricing will be outlined in a separate project agreement or proposal.
                            </p>
                            ...
                            <p className="text-gray-700 mb-4">
                                <strong>6.2 Portfolio Rights:</strong> Bianca Butler Christa reserves the right to display completed projects in our portfolio and marketing materials unless otherwise agreed in writing.
                            </p>
                            <p className="text-gray-700 mb-6">
                            ...
                            <p className="text-gray-700 mb-6">
                                Bianca Butler Christa&apos;s liability is limited to the amount paid for the services. We are not liable for indirect, incidental, or consequential damages.
                            </p>
